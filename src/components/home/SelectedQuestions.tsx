...
export function SelectedQuestions() {
  return (
    <section id="work" className="mx-auto max-w-content px-5 py-20 md:px-8 md:py-24 lg:py-32">
      <SectionHeading
      ...
      <div className="mt-10 grid gap-4 md:mt-14 md:grid-cols-2">
        {selectedQuestions.map((card) => (
          <a
            key={card.number}
            href={card.href}
            className="group flex min-h-[250px] flex-col rounded-[1.5rem] border border-white/10 bg-white/[0.018] p-5 transition duration-200 hover:border-white/30 hover:bg-white/[0.04] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-accent sm:min-h-[280px] md:rounded-[1.75rem] md:p-8"
          ...
          >
            ...
            <h3 className="mt-10 whitespace-pre-line break-keep text-[25px] font-normal leading-[1.25] text-white sm:text-[28px] md:mt-12 md:text-[34px]">
              {card.question}
            </h3>
